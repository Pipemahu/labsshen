...
<h1>Resultados para  
  ...
  <option value="resultados.php">Seleccione Empresa a Evaluar</option>
 ...
 ?>
  ...
  <option value="resultados.php?id=<?=$Valor[0]?>" <? if($_GET['id']==$Valor[0]){ ?> selected="selected" <? } ?>><?=utf8_encode($Valor[3])?></option>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="500" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="90">Rut</td>
        <td width="410"><?=utf8_encode($empresa[0][2])?></td>
      </tr>
      <tr>
        <td>Razon Social</td>
...
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <? $id_empresa = $_GET['id']; ?>
    <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&lista=elementos" style=" color:#FFF">Lista de Elementos</a></td>
     <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&lista=subelementos" style=" color:#FFF">Lista de Subelementos </a></td>
    <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&lista=preguntas" style=" color:#FFF">Lista de Preguntas</a></td>
   
    
    <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&lista=mejoras" style=" color:#FFF">Oportunidades de Mejora</a></td>
    <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&amp;lista=area" style=" color:#FFF">Promedio por Area</a></td>
    <td width="15%" align="center" bgcolor="#000000"><a href="resultados.php?id=<?=$id_empresa?>&amp;lista=ISO" style=" color:#FFF">Promedio 24 areas ISO 55000</a></td>
...
<table width="90%" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#F3F4F6">
  ...
  <? $empresas = $mysql->Select("select * from preguntas order by num asc");
 	if(count($empresas)!=0){
		foreach ($empresas as $Valor){
			$estado_pregunta = $mysql->Select("select estado 
 ...
 ?>
  ...
  <tr>
   ...
   <br />
    ...
    <td align="center" bgcolor="#FFFFFF"><a href="pregunta.php?idcliente=<?=$id_cliente?>&idpregunta=<?=$id_pregunta?>"><img src="images/icono_enlace_externo.png" width="12" height="12" border="0" /></a></td>
  </tr>
...
?>
 ...
 ?>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><a href="pregunta.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$Valor[5]?>&item=<?=$Valor[4]?>"><img src="images/icono_enlace_externo.png" width="12" height="12" border="0" /></a></td>
  </tr>
