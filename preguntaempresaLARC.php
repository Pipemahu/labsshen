...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#E8E8E8">
 ...
 ?>
  ...
  <tr>
	...
	?>
     ...
     <form action="preguntaempresaLARC.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$id_pregunta?>&item=<?=$Valor[0]?>" method="post">
 ...
 ?> 
          <tr>
            ...
            <td align="center"><a href="preguntaempresaLARC.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$id_pregunta?>&borrarmejora=<?=$Valor2[0]?>&item=<?=$Valor[0]?>"><img src="images/delete.gif" width="16" height="16" border="0" /></a></td>
          </tr>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <h2> <a href="preguntaempresaLARC.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$id_pregunta_nuevo?>">Pregunta Anterior</a></h2>
    <? } ?>
    
    </td>
    <td width="33%" align="center"><h2><a href="evaluar2empresaLARC.php?id=<?=$empresa[0][0]?>">Lista de Preguntas</a></h2></td>
    ...
    <? if($id_pregunta_nuevo!=""){ ?>
   <h2> <a href="preguntaempresaLARC.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$id_pregunta_nuevo?>">Pregunta Siguiente</a></h2>
    <? } ?>
    </td>
  </tr>
</table>
