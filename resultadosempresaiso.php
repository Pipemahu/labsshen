...
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <? $id_empresa = $_GET['id']; ?>
    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosempresaiso.php?id=<?=$id_empresa?>&lista=elementos" style=" color:#FFF">Lista de Elementos</a></td>
     <td width="25%" align="center" bgcolor="#000000"><a href="resultadosempresaiso.php?id=<?=$id_empresa?>&lista=subelementos" style=" color:#FFF">Lista de Subelementos </a></td>
    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosempresaiso.php?id=<?=$id_empresa?>&lista=preguntas" style=" color:#FFF">Lista de Preguntas</a></td>
   
    
    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosempresaiso.php?id=<?=$id_empresa?>&lista=mejoras" style=" color:#FFF">Oportunidades de Mejora</a></td>
