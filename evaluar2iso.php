...
<h1>Evaluacion para  <select name="empresas" class="select-empresa" id="empresas" onchange="MM_jumpMenu('parent',this,0)">
  <option value="evaluar2iso.php">Seleccione Empresa a Evaluar</option>
 ...
 ?>
  ...
  <option value="evaluar2iso.php?id=<?=$Valor[0]?>" <? if($_GET['id']==$Valor[0]){ ?> selected="selected" <? } ?>><?=utf8_encode($Valor[3])?></option>
    ...
    <div id="pregunta_extendida_<?=$Valor[0]?>" <? if($estado=="0"){ echo "style=\"display:none\""; } ?>>
      ...
      <tr>
        ...
        <td width="151" rowspan="6" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center"><h2><a href="preguntaiso.php?idcliente=<?=$empresa[0][0]?>&idpregunta=<?=$Valor[0]?>">Responder</a></h2></td>
          </tr>
        </table></td>
        </tr>
      <tr>
