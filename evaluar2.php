...
<h1>Evaluacion para  <select name="empresas" class="select-empresa" id="empresas" onchange="MM_jumpMenu('parent',this,0)">
  <option value="evaluar2.php">Seleccione Empresa a Evaluar</option>
 ...
 ?>
  ...
  <option value="evaluar2.php?id=<?=$Valor[0]?>" <? if($_GET['id']==$Valor[0]){ ?> selected="selected" <? } ?>><?=utf8_encode($Valor[3])?></option>
