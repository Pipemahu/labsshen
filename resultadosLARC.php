...
function calcula_promedio_para_area($consulta_preguntas)
{
	...
	$preguntas = $mysql->Select("Select ID_preguntas from Preguntas_LARC where ".$consulta_preguntas." order by num");
	...
	foreach ($preguntas as $Valor2){
		...
		if($estado_pregunta=="0"){
			...
			$items = $mysql->Select("
										select items_LARC.ID_Items, items_LARC.item, notas_LARC.nota
										from items_LARC, notas_LARC
										where items_LARC.ID_preguntas='$id_pregunta'
										and notas_LARC.ID_clientes='$id_cliente'
										and notas_LARC.ID_items = items_LARC.ID_items;");
			$nro_item = $mysql->Select("select ID_items from items_LARC where ID_Preguntas='$id_pregunta'");
...
<h1>Resultados para  
  ...
  <option value="resultadosLARC.php">Seleccione Empresa a Evaluar</option>
 ...
 ?>
  ...
  <option value="resultadosLARC.php?id=<?=$Valor[0]?>" <? if($_GET['id']==$Valor[0]){ ?> selected="selected" <? } ?>><?=utf8_encode($Valor[3])?></option>
    ...
    <td><table width="500" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><?=$empresa[0][4]?></td>
                                    ...
                                    <tr>
                                    <? $id_empresa = $_GET['id']; ?>
                                    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosLARC.php?id=<?=$id_empresa?>&lista=elementos" style=" color:#FFF">Lista de Elementos</a></td>
                                    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosLARC.php?id=<?=$id_empresa?>&lista=subelementos" style=" color:#FFF">Lista de Subelementos </a></td>
                                    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosLARC.php?id=<?=$id_empresa?>&lista=preguntas" style=" color:#FFF">Lista de Preguntas</a></td>
                                    
                                    
                                    <td width="25%" align="center" bgcolor="#000000"><a href="resultadosLARC.php?id=<?=$id_empresa?>&lista=mejoras" style=" color:#FFF">Oportunidades de Mejora</a></td>
                                    ...
                                    <tr>
                                    <? $id_empresa = $_GET['id']; ?>
                                    <td colspan="4" align="right" bgcolor="#B6B8AD"><a href="exportar-cvs-preguntas-LARC.php?id=<?=$id_empresa?>">Exportar a Excel</a></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <? $empresas = $mysql->Select("select * from Preguntas_LARC order by num asc");
                                    if(count($empresas)!=0){
                                    foreach ($empresas as $Valor){
                                    $estado_pregunta = $mysql->Select("
                                                                      ...
                                                                      $items = $mysql->Select("
                                                                                              ...
                                                                                              <td align="center" bgcolor="#FFFFFF"><a href="preguntaempresaLARC.php?idcliente=<?=$id_cliente?>&idpregunta=<?=$id_pregunta?>"><img src="images/icono_enlace_externo.png" width="12" height="12" border="0" /></a></td>
                                                                                              </tr>
                                                                                              ...
                                                                                              <td colspan="3" align="right" bgcolor="#B6B8AD"><a href="exportar-cvs-elementos-LARC.php?id=<?=$id_empresa?>">Exportar a Excel</a></td>
                                                                                              </tr>
                                                                                              <tr>
                                                                                              ...
                                                                                              <? $elementos = $mysql->Select("SELECT DISTINCT elemento FROM Preguntas_LARC");
                                                                                              ...
                                                                                              <? $preguntas = $mysql->Select("Select ID_preguntas from Preguntas_LARC where elemento = '$Valor[0]' order by num");
                                                                                              $num_preguntas = count($preguntas); ?>
                                                                            ...
                                                                            array_push($promedio_elementos , number_format($promedio_elemento,2))                                          ?>
                                                                                                                      ...
                                                                                                                      <td align="center" bgcolor="#FFFFFF"><a href="evaluar2empresaLARC.php?id=<?=$id_cliente?>"><img src="images/icono_enlace_externo.png" alt="" width="12" height="12" border="0" /></a></td>
                                                                                                                      </tr>
                                                                                                                      ...
                                                                                                                      $myPicture->drawText(300,13,"Elementos - Cuestionario LARC",array("R"=>255,"G"=>255,"B"=>255));
                                                                                                                      ...
                                                                                                                      $myPicture->drawText(550,100,"1.- Liderando el mejoramiento",$TextSettings);
                                                                                                                      $myPicture->drawText(550,150,"2.- Contratos de suministros ",$TextSettings);
                                                                                                                      $myPicture->drawText(550,200,"3.- Almacenamiento y despacho a máquinas",$TextSettings);
                                                                                                                      $myPicture->drawText(550,250,"4.- Operación de máquinas ",$TextSettings);
                                                                                                                      $myPicture->drawText(550,300,"5.- Administración de LARC",$TextSettings);
                                                                                                                      $myPicture->drawText(550,350,"6.- Disposición de LARC",$TextSettings);
                                                                                                                      $myPicture->drawText(550,400,"7.- Mejoramiento continuo",$TextSettings);
                                                                                                                      ...
                                                                                                                      <tr>
                                                                                                                      <? $id_empresa = $_GET['id']; ?>
                                                                                                                      <td colspan="3" align="right" bgcolor="#B6B8AD"><a href="exportar-cvs-subelementos-LARC.php?id=<?=$id_empresa?>">Exportar a Excel</a></td>
                                                                                                                      </tr>
                                                                                                                      <tr>
                                                                                                                      ...
                                                                                                                      <? $elementos = $mysql->Select("	SELECT DISTINCT subelemento
                                                                                                                                                     ...
                                                                                                                                                     <?
                                                                                                                                                     $preguntas = $mysql->Select("Select ID_preguntas from Preguntas_LARC where subelemento = '$Valor[0]' order by num");
                                                                                                                                                     $num_preguntas = count($preguntas);
                                                                                                                                                     ?>
                                                                                                                                                     ...
                                                                                                                                                     $items = $mysql->Select("
                                                                                                                                                                             ...
                                                                                                                                                                             <tr>
                                                                                                                                                                             <? $id_empresa = $_GET['id']; ?>
                                                                                                                                                                             <td colspan="5" align="right" bgcolor="#B6B8AD"><a href="exportar-cvs-oportunidades-de-mejora-LARC.php?id=<?=$id_empresa?>">Exportar a Excel</a></td>
                                                                                                                                                                             </tr>
                                                                                                                                                                             <tr>
                                                                                                                                                                             ...
                                                                                                                                                                             <? $empresas = $mysql->Select("
                                                                                                                                                                                                           SELECT mejoras_LARC.mejora, mejoras_LARC.complejidad, mejoras_LARC.beneficio, mejoras_LARC.complejidad *  mejoras_LARC.beneficio AS indice, mejoras_LARC.ID_items, items_LARC.ID_preguntas
                                                                                                                                                                                                           FROM mejoras_LARC, items_LARC
                                                                                                                                                                                                           WHERE mejoras_LARC.ID_clientes = '$id_empresa'
                                                                                                                                                                                                           AND items_LARC.ID_items = mejoras_LARC.ID_items
                                                                                                                                                                                                           ...
                                                                                                                                                                                                           <td align="center" bgcolor="#FFFFFF"><a href="preguntaempresaLARC.php?idcliente=<?=$id_empresa?>&idpregunta=<?=$Valor[5]?>&item=<?=$Valor[4]?>"><img src="images/icono_enlace_externo.png" width="12" height="12" border="0" /></a></td>
                                                                                                                                                                                                           </tr>
